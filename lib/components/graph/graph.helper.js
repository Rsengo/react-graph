...
function _createForceSimulation(width, height, gravity) {
    ...
    return (0, _d3Force.forceSimulation)().force("charge", (0, _d3Force.forceManyBody)().strength(forceStrength)); // .force("x", frx)
    // .force("y", fry);
}
/**
...
function _colorGroups(groups) {
    return groups.map(function(group) {
        return _objectSpread({}, group, {
            fillColor: group.fillColor || (0, _colors.generateRainbowColor)(),
        });
    });
}
/**
