...
var _changes = require("./changes.helper");
...
var Graph = /*#__PURE__*/ (function(_React$Component) {
        ...
        },
        {
            ...
            value: function _graphBindD3ToReactComponent() {
                if (!this.state.config.d3.disableLinkForce) {
                    ...
                    (0, _simulationHelper.graphLinkForceConfig)(
    ...
    function Graph(props) {
        ...
        _defineProperty(_assertThisInitialized(_this), "_setNodeHighlightedValue", function(id) {
            ...
            _this._tick(
                (0, _graph3.updateNodeHighlightedValue)(
                    _this.state.nodes,
                    _this.state.collapsedNodes,
                    _this.state.links,
                    _this.state.collapsedLinks,
                    _this.props.groupsCollapsed,
                    _this.state.config,
                    id,
                    value
                )
        ...
        _defineProperty(_assertThisInitialized(_this), "_zoomConfig", function() {
            (0, _d3Selection.select)("#".concat(_this.state.id, "-").concat(_graph["default"].GRAPH_WRAPPER_ID))
                .call(_this._zoom)
        ...
        _defineProperty(_assertThisInitialized(_this), "_zoomed", function() {
            ...
            var groupsCollapsed =
                transform.k <= _this.state.config.group.collapseZoom && _this.state.config.group.collapsible;

            if (_this.props.onZoom) {
                _this.props.onZoom(transform.k, groupsCollapsed);
            }
        });

        _defineProperty(_assertThisInitialized(_this), "zoomTo", function(scale) {
            (0, _d3Selection.selectAll)(
                "#".concat(_this.state.id, "-").concat(_graph["default"].GRAPH_WRAPPER_ID)
            ).call(_this._zoom.scaleTo, scale);
        });
    ...
    _createClass(Graph, [
        {
            ...
            value: function UNSAFE_componentWillReceiveProps(nextProps) {
                var _checkForGraphElement = (0, _changes.checkForGraphElementsChanges)(nextProps, this.state),
                ...
                var _checkForGraphConfigC = (0, _changes.checkForGraphConfigChanges)(nextProps, this.state),
